function [vspglmmodel, formulas] = fit_vspglm_constraint(formula, tbl, links, index, fixed)
...
%     end
    ...
    [maxloglike, params, converged] = vspglm_constraint(Y, X, links, Aeq, index, fixed);
    vspglmmodel = struct([]);   
